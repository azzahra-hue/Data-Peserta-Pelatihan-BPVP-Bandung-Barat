    ...
    switch (entityType) {
      case "participants":
        return [
          ...
          { key: "alamat", label: "Alamat", required: true, candidates: ["alamat", "alamat domisili", "domisili", "address", "alamat tinggal"], description: "Alamat tempat tinggal lengkap" },
          ...
          { key: "lokasi", label: "Lokasi Penempatan (Kota/Kab)", required: false, candidates: ["lokasi", "lokasi penempatan", "lokasi kerja", "kota penempatan", "kota kerja", "kabupaten", "daerah penempatan", "lokasi_penempatan"], description: "Daerah penempatan (contoh: Kab. Subang, Kota Bandung)" },
